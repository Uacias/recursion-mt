...
import innerCircuit from "../circuits/execute/target/execute.json" assert { type: "json" };
...
(async () => {
  try {
    ...
    const inputs = {
      root_1:
        "0x1a44be2dfa217b366ddd77a5b14415504ac4a4775e8d9d2c3b030526b45686a0",
      secret_1:
        "0x1344b7a78d5b8c6b48def17a5987dd4f24e728ec6e1c6ff188d106e1ae9839aa",
      nullifier_1:
        "0x1828f6363c3b5aec7c212addb41462622e4a3766a945d8304bd17c00f1adb44b",
      ...
      root_2:
        "0x1a44be2dfa217b366ddd77a5b14415504ac4a4775e8d9d2c3b030526b45686a0",
      secret_2:
        "0xce28b55aae81eaf127e3a106b7017d066b276dda4da41de90c2ef6f2a2fac4b",
      nullifier_2:
        "0x4798d4ce7d47be70c75080c94b45a58b5ca434013a96cb3cffa1217a8c497b8",
      ...
      refund_secret_1:
        "0xfd6b2f79e492b5ed607e543fbcec78b0c29dbf38973289596a94622fe320a81",
      refund_nullifier_1:
        "0x11bdbd364d3241d83872e523a4748c6963f42572c77f389cd1bd45ceaf0cebb1",
      refund_amount_1: "0x4563918244f40000",
      refund_commitment_hash_1:
        "0x1f6eb9e2abe107077ae948e1a95b3f6cd13bbe08144bb79b97bce7580fb623a6",
      refund_secret_2:
        "0x94a8f6cfbde9f614cea119c48a301e2952130807d85c9caaf8a56a6ab88eaa7",
      refund_nullifier_2:
        "0x6db11e182f47a9ff470011dd69860800fd5d043069c6f76b01f9e6a3873b6f6",
      refund_amount_2: "0x28bccd634a8cd240",
      refund_commitment_hash_2:
        "0x1b5fdaea50710330b52c0756cb17d1806c2b473d703b6d8424166f170681f9c0",
      _recipient:
        "0x064fa47c02430E5d69c0c5d340e23397bca308f7B9d85247565fc91F2C2aD2f2",
    };
    ...
    const arrayBuffer = await readFile("../circuits/execute/target/vk.bin");
