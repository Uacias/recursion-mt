use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_27_circuit,
};
...
mod UltraKeccakHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_27_circuit, vk,
    };
    ...
    impl IUltraKeccakHonkVerifier of super::IUltraKeccakHonkVerifier<ContractState> {
        fn verify_ultra_keccak_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_27_circuit(
